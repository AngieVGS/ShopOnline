...
//		add(buttonSeeAll);
	...
	public Object[] getListValuesForFilter() {
		...
		return new Object[] {textFiledSearchById.getText(), textFiledSearchByName.getText(), spinnerSearchByPriceMin.getValue(), spinneSearchByPriceMax.getValue(), comboBoxSearchByCategory.getSelectedItem()};
	}
}
